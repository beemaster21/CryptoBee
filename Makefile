#############################################################################
# Makefile for building: cryptobee-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Feb 5 19:23:48 2017
# Project:  CryptoBee-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile CryptoBee-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/CryptoBee/src/leveldb/libleveldb.a /tmp/CryptoBee/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: CryptoBee-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile CryptoBee-qt.pro
...
/tmp/CryptoBee/src/leveldb/libleveldb.a: FORCE
	cd /tmp/CryptoBee/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

build/build.h: FORCE
	cd /tmp/CryptoBee; /bin/sh share/genbuild.sh build/build.h
